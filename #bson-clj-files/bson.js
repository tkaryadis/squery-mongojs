...
//<cljs/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//export one more function for deserializing js
function deserializeCljs(buffer, options) {
    if (options === void 0) { options = {}; }
    return deserializer_1.deserializeCljs(ensure_buffer_1.ensureBuffer(buffer), options,false,true);
}
exports.deserializeCljs = deserializeCljs;
//>cljs/////////////////////////////////////////////////////////////////////////////////////////////////////////////////
