...
//2 functions for cljs data
function getArraySize(isClojureVector,array)             //cljs
{
  if(isClojureVector) return cljs.core.count(array);    //cljs
  else return array.length;
}
function getArrayMember(isClojureVector,array,index)      //cljs
{
  if(isClojureVector) return cljs.core.get(array,index);   //cljs
...
function serializeInto(buffer, object, checkKeys, startingIndex, depth, serializeFunctions, ignoreUndefined, path)
{
    ...
    if (cljs.core.map_QMARK_(object))    //cljs
    {
      isClojureMap=true;                 //cljs
    }
    else if(cljs.core.vector_QMARK_(object))  //cljs
    {
    ...
    else
    {
        ...
        else  //cljs clojure map case
        {
           ...
           while(cljs.core.seq(pairs))
           {
             var pair = cljs.core.first(pairs);
